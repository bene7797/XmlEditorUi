...
public class TemplateFieldMapping
{
    ...
    {
        { "COURSE_TYPE", "SERVICE_DETAILS/EXTENDED_INFO/COURSE_TYPE" },
        { "INSTRUCTION_TIME", "SERVICE_DETAILS/SERVICE_MODULE/EDUCATION/EXTENDED_INFO/INSTRUCTION_TIME" },
        { "DURATION", "SERVICE_DETAILS/SERVICE_MODULE/EDUCATION/EXTENDED_INFO/DURATION" },
    };
    ...
    public static readonly Dictionary<string, string> CourseTypeFieldAttributes = new()
    {
        ...
        { "DURATION@type", "SERVICE_DETAILS/SERVICE_MODULE/EDUCATION/EXTENDED_INFO/DURATION@type" },
    };
